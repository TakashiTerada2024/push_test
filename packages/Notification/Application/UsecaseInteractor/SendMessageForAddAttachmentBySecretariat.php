 ...
 */
class SendMessageForAddAttachmentBySecretariat implements SendMessageForAddAttachmentBySecretariatInterface
{
    public function __construct(private NotificationSenderInterface $notificationSender)
    {
    }

    public function __invoke(int $targetUserId, SendAddAttBySecretariatParameterInterface $parameter)
    {
        $this
            ->notificationSender
            ->setTargetUserId($targetUserId)
            ->sendMessageForAddAttachmentBySecretariat($parameter);
    }
}
