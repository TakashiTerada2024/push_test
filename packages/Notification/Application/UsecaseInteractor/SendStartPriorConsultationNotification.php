...
namespace Ncc01\Notification\Application\UsecaseInteractor;
 ...
 *
 * @package Ncc01\Notification\Application\UsecaseInteractor
 */
class SendStartPriorConsultationNotification implements SendStartPriorConsultationNotificationInterface
{
    ...
    public function __invoke(SendStartPriorConsultationParameterInterface $parameter)
    {
        $this
            ->notificationSender
            ->setTargetUserId($this->allSecretariatUser->getId())
            ->sendStartPriorConsultation($parameter);
    }
}
