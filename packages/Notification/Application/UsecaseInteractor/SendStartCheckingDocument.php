...
class SendStartCheckingDocument implements SendStartCheckingDocumentInterface
{
    ...
    public function __invoke(SendStartCheckingDocumentParameterInterface $parameter)
    {
        $this
            ->notificationSender
            ->setTargetUserId($this->allSecretariatUser->getId())
            ->sendStartCheckingDocument($parameter);
    }
}
