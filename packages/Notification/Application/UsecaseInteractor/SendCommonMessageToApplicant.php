 ...
 */
class SendCommonMessageToApplicant implements SendCommonMessageToApplicantInterface
{
    public function __construct(private NotificationSenderInterface $notificationSender)
    {
    }

    public function __invoke(int $targetUserId, SendCommonMessageParameterInterface $parameter)
    {
        $this
            ->notificationSender
            ->setTargetUserId($targetUserId)
            ->sendCommonMessageToApplicant($parameter);
    }
}
