 ...
 */
class SendMessageForEditToApplicant implements SendMessageForEditToApplicantInterface
{
    public function __construct(private NotificationSenderInterface $notificationSender)
    {
    }

    public function __invoke(int $targetUserId, SendMessageForEditParameterInterface $parameter)
    {
        $this
            ->notificationSender
            ->setTargetUserId($targetUserId)
            ->sendMessageForEditToApplicant($parameter);
    }
}
