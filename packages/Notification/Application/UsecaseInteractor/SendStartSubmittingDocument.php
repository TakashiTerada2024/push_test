...
class SendStartSubmittingDocument implements SendStartSubmittingDocumentInterface
{
    ...
    public function __invoke(int $targetUserId, SendStartSubmittingDocumentParameterInterface $parameter)
    {
        $this
            ->notificationSender
            ->setTargetUserId($targetUserId)
            ->sendStartSubmittingDocument($parameter);
    }
}
