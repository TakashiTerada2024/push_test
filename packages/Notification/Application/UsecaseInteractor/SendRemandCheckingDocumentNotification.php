...
class SendRemandCheckingDocumentNotification implements SendRemandCheckingDocumentInterface
{
    public function __construct(private NotificationSenderInterface $notificationSender)
    {
    }

    public function __invoke(int $targetUserId, SendRemandCheckingDocumentParameterInterface $parameter)
    {
        $this
            ->notificationSender
            ->setTargetUserId($targetUserId)
            ->sendRemandCheckingDocument($parameter);
    }
}
