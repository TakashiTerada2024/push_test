...
class SendStartCreatingDocument implements SendStartCreatingDocumentInterface
{
    ...
    public function __invoke(int $targetUserId, SendStartCreatingDocumentParameterInterface $parameter)
    {
        $this
            ->notificationSender
            ->setTargetUserId($targetUserId)
            ->sendStartCreatingDocument($parameter);
    }
}
