...
/**
 * SendStartPriorConsultationNotificationParameter
 *
 * @package Ncc01\Notification\Application\InputData
 */
class SendStartPriorConsultationParameter extends BaseParameter implements SendStartPriorConsultationParameterInterface
{
    private MessageBodyDto $dto;

    /**
     * @return MessageBodyDto
     */
    public function getDto(): MessageBodyDto
    {
        return $this->dto;
    }

    /**
     * @param MessageBodyDto $dto
     */
    public function setDto(MessageBodyDto $dto): void
    {
        $this->dto = $dto;
    }
}
