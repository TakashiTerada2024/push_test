...
use Ncc01\Notification\Application\InputBoundary\SendMessagingNotificationParameterInterface;

abstract class SendMessagingNotificationParameter implements SendMessagingNotificationParameterInterface
{
    private int $applyId;
