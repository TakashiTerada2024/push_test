 ...
 */
class SaveApplySection08Parameter implements SaveApplySection08ParameterInterface
{
    ...
    /**
     * @param string|null $scheduledToBeAnnounced
     */
    public function setScheduledToBeAnnounced(?string $scheduledToBeAnnounced): void
    {
