 ...
 */
class RetrieveApplicantById implements RetrieveApplicantByIdInterface
{
    /** @var ApplyRepositoryInterface $applyRepository */
    private $applyRepository;

    /**
     * RetrieveApplicantById constructor.
     ...
     */
    public function __invoke(int $applyId): User
    {
        $apply = $this->applyRepository->findById($applyId);
        return new User($apply->getApplicant());
    }
}
