...
use Ncc01\Apply\Application\OutputData\ApplyBaseInfo;
use Ncc01\Apply\Application\Usecase\RetrieveApplyBaseInfoInterface;

/**
 * RetrieveApplyBaseInfo
 *
 * @package Ncc01\Apply\Application\UsecaseInteractor
 */
class RetrieveApplyBaseInfo implements RetrieveApplyBaseInfoInterface
{
    ...
    public function __invoke(int $applyId): ApplyBaseInfoInterface
    {
        $apply = $this->applyRepository->findById($applyId);
        return new ApplyBaseInfo($apply);
    }
}
