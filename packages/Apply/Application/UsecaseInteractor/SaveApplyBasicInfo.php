...
/**
 * Class SaveApplyBasicInfo
 * @package Ncc01\Apply\Application\Usecase
 */
class SaveApplyBasicInfo implements SaveApplyBasicInfoInterface
{
     ...
     * __invoke
     *
     * @param SaveApplySectionBasicInfoParameterInterface $parameter
     * @param int $applyId
     * @author kenji yamamoto <k.yamamoto@balocco.info>
     */
    public function __invoke(SaveApplySectionBasicInfoParameterInterface $parameter, int $applyId): void
    {
        $arrayParameter = [
