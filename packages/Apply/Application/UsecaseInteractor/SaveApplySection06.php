 ...
 */
class SaveApplySection06 implements SaveApplySection06Interface
{
    /** @var ApplyRepositoryInterface $applyRepository */
    private $applyRepository;

    /**
     * SaveApplySection06 constructor.
     ...
     * __invoke
     *
     * @param SaveApplySection06ParameterInterface $parameter
     * @param int $applyId
     * @author kenji yamamoto <k.yamamoto@balocco.info>
     */
    public function __invoke(SaveApplySection06ParameterInterface $parameter, int $applyId): void
    {
        $arrayParameter = [
            '6_usage_period_end' => $parameter->getUsagePeriodEnd(),
