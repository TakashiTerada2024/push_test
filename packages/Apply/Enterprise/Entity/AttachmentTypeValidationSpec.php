...
/**
 * AttachmentTypeValidationSpec
 *
 * @package Ncc01\Apply\Enterprise\Entity
 */
class AttachmentTypeValidationSpec extends ValidationSpec
{
    /** @var \GitBalocco\KeyValueList\Contracts\KeyValueListable $list */
    private $list;
    ...
    public function __construct($candidate)
    {
        ...
        $this->list = $attachmentTypes->listOfId();
    }
    ...
    public function isSatisfied(): bool
    {
        ...
        try {
            ...
            V::intType()->in($this->list->all())->assert($candidate);
            $result = true;
