 ...
 */
class AttachmentStatuses extends KeyValueList
{
    /** @var int UPLOADED アップロード */
    public const UPLOADED = 1;
    /** @var int SUBMITTING 提出中 */
    public const SUBMITTING = 2;
    /** @var int APPROVED 承認済み */
