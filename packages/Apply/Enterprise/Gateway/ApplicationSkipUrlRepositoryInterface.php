...
/**
 * ApplicationSkipUrlRepositoryInterface
 *
 * @package Ncc01\Apply\Enterprise\Gateway
 */
interface ApplicationSkipUrlRepositoryInterface
{
    /**
     * スキップURLエンティティを保存する
     *
    ...
    /**
     * 新しいスキップURLエンティティを作成する
     *
     * @param int $applyTypeId 申請種別ID
