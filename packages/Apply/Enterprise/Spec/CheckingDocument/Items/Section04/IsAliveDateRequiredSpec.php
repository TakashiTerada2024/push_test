...
/**
 * IsAliveDateRequiredSpec
 *
 * @package Ncc01\Apply\Enterprise\Spec\CheckingDocument2\Items\Section04
 */
class IsAliveDateRequiredSpec extends ValidationSpec
{
    ...
    {
        return '4_is_alive_date_required';
    }

    public function getSpecName(): string
    {
        return (new QuestionItemName())->value('4_is_alive_date_required');
    }
}
