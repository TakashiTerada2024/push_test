...
/**
 * IsCauseOfDeathRequired
 *
 * @package Ncc01\Apply\Enterprise\Spec\CheckingDocument2\Items\Section04
 */
class IsCauseOfDeathRequired extends ValidationSpec
{
    public function definition(): mixed
    {
        return Validator::notEmpty()->intType()->in([1, 2]);
    }

    public function getSpecKey(): string
    {
        return '4_is_cause_of_death_required';
    }

    public function getSpecName(): string
    {
        return (new QuestionItemName())->value('4_is_cause_of_death_required');
    }
}
