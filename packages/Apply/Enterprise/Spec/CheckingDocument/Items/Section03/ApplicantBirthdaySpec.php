...
/**
 * ApplicantBirthdaySpec
 *
 * @package Ncc01\Apply\Enterprise\Spec\CheckingDocument2\Items\Section03
 */
class ApplicantBirthdaySpec extends ValidationSpec
{
    ...
    {
        return '10_applicant_birthday';
    }

    public function getSpecName(): string
    {
        return (new QuestionItemName())->value('10_applicant_birthday');
    }
}
