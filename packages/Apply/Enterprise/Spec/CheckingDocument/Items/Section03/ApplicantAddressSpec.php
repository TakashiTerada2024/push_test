...
/**
 * ApplicantAddressSpec
 *
 * @package Ncc01\Apply\Enterprise\Spec\CheckingDocument2\Items\Section03
 */
class ApplicantAddressSpec extends ValidationSpec
{
    public function __construct(mixed $candidate, private ?int $applicantType)
    {
    ...
    {
        return '10_applicant_address';
    }

    public function getSpecName(): string
    {
        $key = $this->applicantType === 2 ? '10_applicant_address_2' : '10_applicant_address_1';
        return (new QuestionItemName())->value($key);
    }
}
