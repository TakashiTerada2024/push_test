 ...
 * AffiliationSpec
 *
 * @package Ncc01\Apply\Enterprise\Spec\CheckingDocument\Items\Section03
 */
class AffiliationSpec extends ValidationSpec
{
    ...
    {
        $key = $this->applicantType === 2 ? 'affiliation_2' : 'affiliation_1';
