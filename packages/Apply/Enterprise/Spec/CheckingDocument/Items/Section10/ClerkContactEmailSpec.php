...
/**
 * ClerkContactEmailSpec
 *
 * @package Ncc01\Apply\Enterprise\Spec\CheckingDocument\Items\Section03
 */
class ClerkContactEmailSpec extends ValidationSpec
{
    ...
    {
        return '10_clerk_contact_email';
    }

    public function getSpecName(): string
    {
        return (new QuestionItemName())->value('10_clerk_contact_email');
    }
}
