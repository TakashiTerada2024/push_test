 ...
 */
class ClerkContactPhoneNumberSpec extends ValidationSpec
{
    ...
    {
        return '10_clerk_contact_phone_number';
    }

    public function getSpecName(): string
    {
        return (new QuestionItemName())->value('10_clerk_contact_phone_number');
    }
}
