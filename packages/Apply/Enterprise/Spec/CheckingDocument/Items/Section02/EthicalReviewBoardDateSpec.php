 ...
 */
class EthicalReviewBoardDateSpec extends ValidationSpec
{
    ...
    {
        return '2_ethical_review_board_date';
    }

    public function getSpecName(): string
    {
        return (new QuestionItemName())->value('2_ethical_review_board_date');
    }
}
