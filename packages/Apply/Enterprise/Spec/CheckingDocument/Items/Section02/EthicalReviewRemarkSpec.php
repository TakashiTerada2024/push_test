...
/**
 * EthicalReviewRemarkSpec
 *
 * @package Ncc01\Apply\Enterprise\Spec\CheckingDocument\Items\Section02
 */
class EthicalReviewRemarkSpec extends ValidationSpec
{
    ...
    {
        return '2_ethical_review_remark';
    }

    public function getSpecName(): string
    {
        return (new QuestionItemName())->value('2_ethical_review_remark');
    }
}
