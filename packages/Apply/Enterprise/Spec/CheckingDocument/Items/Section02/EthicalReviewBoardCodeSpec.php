 ...
 */
class EthicalReviewBoardCodeSpec extends ValidationSpec
{
    ...
    {
        return '2_ethical_review_board_code';
    }

    public function getSpecName(): string
    {
        return (new QuestionItemName())->value('2_ethical_review_board_code');
    }
}
