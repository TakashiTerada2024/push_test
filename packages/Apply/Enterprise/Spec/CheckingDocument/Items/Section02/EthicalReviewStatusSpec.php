...
/**
 * EthicalReviewStatusSpec
 *
 * @package Ncc01\Apply\Enterprise\Spec\CheckingDocument\Items\Section02
 */
class EthicalReviewStatusSpec extends ValidationSpec
{
    ...
    {
        return '2_ethical_review_status';
    }

    public function getSpecName(): string
    {
        return (new QuestionItemName())->value('2_ethical_review_status');
    }
}
