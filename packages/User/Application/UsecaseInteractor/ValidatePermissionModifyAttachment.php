...
use Ncc01\User\Application\Usecase\ValidatePermissionParameters\ValidateModifyAttachmentParameter;

/**
 * ValidatePermissionModifyAttachment
 *
 * @package Ncc01\User\Application\UsecaseInteractor
 */
class ValidatePermissionModifyAttachment implements ValidatePermissionModifyAttachmentInterface
{
    /**
     * __construct
     *
     * @param ValidatePermission $validatePermissionService
     * @param ValidateModifyAttachmentParameter $validateModifyAttachmentParameter
    ...
    public function __construct(
        ...
        private ValidateModifyAttachmentParameter $validateModifyAttachmentParameter,
    ...
    private function withAttachmentId(int $attachmentId): bool
    {
        ...
        $this->validateModifyAttachmentParameter->setAttachment($attachment);
        $this->validateModifyAttachmentParameter->setApply($apply);

        return $this->validatePermissionService->__invoke($this->validateModifyAttachmentParameter);
    }
    ...
    private function withApplyId(int $applyId): bool
    {
        ...
        $this->validateModifyAttachmentParameter->setAttachment(null);
        $this->validateModifyAttachmentParameter->setApply($apply);
