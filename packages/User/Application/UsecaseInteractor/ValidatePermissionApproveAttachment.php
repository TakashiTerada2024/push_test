...
use Ncc01\User\Application\Usecase\ValidatePermissionApproveAttachmentInterface;
use Ncc01\User\Application\Usecase\ValidatePermissionParameters\ValidateApproveAttachmentParameter;

/**
 * ValidatePermissionApproveAttachment
 *
 * @package Ncc01\User\Application\UsecaseInteractor
 */
class ValidatePermissionApproveAttachment implements ValidatePermissionApproveAttachmentInterface
{
    /**
     * __construct
     *
     * @param ValidatePermission $validatePermissionService
     * @param ValidateApproveAttachmentParameter $validateApproveAttachmentParameter
    ...
    public function __construct(
        ...
        private ValidateApproveAttachmentParameter $validateApproveAttachmentParameter,
    ...
    public function __invoke(int $attachmentId): bool
    {
        ...
        $this->validateApproveAttachmentParameter->setAttachment($attachment);

        return $this->validatePermissionService->__invoke($this->validateApproveAttachmentParameter);
    }
}
