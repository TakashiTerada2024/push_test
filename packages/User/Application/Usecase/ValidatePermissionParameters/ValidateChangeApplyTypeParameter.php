...
use Ncc01\User\Enterprise\Spec\Permission\ChangeApplyType;
use Ncc01\User\Enterprise\Spec\Permission\PermissionSpecInterface;
use Ncc01\User\Enterprise\User;

/**
 * ValidateChangeApplyTypeParameter
 *
 * @package Ncc01\User\Application\Usecase\ValidatePermissionParameters
 */
class ValidateChangeApplyTypeParameter implements ValidatePermissionParameterInterface
{
    /**
     * getPermissionSpec
     *
    ...
    {
        return new ChangeApplyType($loginUser->getRole());
    }
}
