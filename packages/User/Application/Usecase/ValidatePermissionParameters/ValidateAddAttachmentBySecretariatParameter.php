...
use Ncc01\User\Enterprise\Spec\Permission\AddAttachmentBySecretariat;
use Ncc01\User\Enterprise\Spec\Permission\PermissionSpecInterface;
use Ncc01\User\Enterprise\User;

/**
 * ValidateAddAttachmentBySecretariatParameter
 * 事務局送付資料の追加権限があるかを確認するために必要な情報を保持するパラメタクラス
 *
 * @package Ncc01\User\Application\Input\Permission
 */
class ValidateAddAttachmentBySecretariatParameter implements ValidatePermissionParameterInterface
{
    /**
     * getPermissionSpec
     *
    ...
    {
        return new AddAttachmentBySecretariat(
