...
use Ncc01\User\Enterprise\Spec\Permission\DisapproveAttachment;
use Ncc01\User\Enterprise\Spec\Permission\PermissionSpecInterface;
use Ncc01\User\Enterprise\User;

/**
 * ValidateDisapproveAttachmentParameter
 *
 * @package Ncc01\User\Application\Usecase\ValidatePermissionParameters
 */
class ValidateDisapproveAttachmentParameter implements ValidatePermissionParameterInterface
{
    ...
    {
        return new DisapproveAttachment(
