...
use Ncc01\User\Enterprise\Spec\Permission\CancelAttachment;
use Ncc01\User\Enterprise\Spec\Permission\PermissionSpecInterface;
use Ncc01\User\Enterprise\User;

/**
 * ValidateCancelAttachmentParameter
 *
 * @package Ncc01\User\Application\Usecase\ValidatePermissionParameters
 */
class ValidateCancelAttachmentParameter implements ValidatePermissionParameterInterface
{
