...
use Ncc01\User\Enterprise\Spec\Permission\ShowApplyList;
use Ncc01\User\Enterprise\User;

/**
 * ValidateShowApplyListParameter
 *
 * @package Ncc01\User\Application\InputData\Permission
 */
class ValidateShowApplyListParameter implements ValidatePermissionParameterInterface
{
    public function getPermissionSpec(User $loginUser): PermissionSpecInterface
    {
        return new ShowApplyList($loginUser->getRole());
    }
}
