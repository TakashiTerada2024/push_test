...
use Ncc01\User\Enterprise\Spec\Permission\ModifyAttachment;
use Ncc01\User\Enterprise\Spec\Permission\PermissionSpecInterface;
use Ncc01\User\Enterprise\User;

/**
 * ValidateModifyAttachmentParameter
 *
 * @package Ncc01\User\Application\Usecase\ValidatePermissionParameters
 */
class ValidateModifyAttachmentParameter implements ValidatePermissionParameterInterface
{
    ...
    {
        return new ModifyAttachment(
            role: $loginUser->getRole(),
            loginUserId: $loginUser->getId(),
            applyStatus: $this->apply->getStatus(),
            applyOwnerUserId: $this->apply->getApplicant()->getId(),
            userIdWhoHasAttachment: $this->attachment?->getUserId(),
