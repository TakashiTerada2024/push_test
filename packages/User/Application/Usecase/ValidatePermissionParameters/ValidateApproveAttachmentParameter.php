...
use Ncc01\User\Enterprise\Spec\Permission\ApproveAttachment;
use Ncc01\User\Enterprise\Spec\Permission\PermissionSpecInterface;
use Ncc01\User\Enterprise\User;

/**
 * ValidateApproveAttachmentParameter
 *
 * @package Ncc01\User\Application\Usecase\ValidatePermissionParameters
 */
class ValidateApproveAttachmentParameter implements ValidatePermissionParameterInterface
{
