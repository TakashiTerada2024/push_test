...
use Ncc01\User\Enterprise\Spec\Permission\ModifyApply;
use Ncc01\User\Enterprise\Spec\Permission\PermissionSpecInterface;
use Ncc01\User\Enterprise\User;

/**
 * ValidateModifyApplyParameter
 * 申出の変更権限があるかを確認するために必要な情報を保持するパラメタクラス
 *
 * @package Ncc01\User\Application\Input\Permission
 */
class ValidateModifyApplyParameter implements ValidatePermissionParameterInterface
{
