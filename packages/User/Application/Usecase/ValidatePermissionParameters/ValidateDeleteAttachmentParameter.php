...
use Ncc01\User\Enterprise\Spec\Permission\DeleteAttachment;
use Ncc01\User\Enterprise\Spec\Permission\PermissionSpecInterface;
use Ncc01\User\Enterprise\User;

/**
 * ValidateDeleteAttachmentParameter
 *
 * @package Ncc01\User\Application\Usecase\ValidatePermissionParameters
 */
class ValidateDeleteAttachmentParameter implements ValidatePermissionParameterInterface
{
