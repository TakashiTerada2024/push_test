...
use Ncc01\User\Enterprise\Spec\Permission\ModifyApplyMemo;
use Ncc01\User\Enterprise\Spec\Permission\PermissionSpecInterface;
use Ncc01\User\Enterprise\User;

/**
 * ValidateModifyApplyMemoParameter
 * 申出メモの変更権限があるかを確認するために必要な情報を保持するパラメタクラス
 *
 * @package Ncc01\User\Application\Input\Permission
 */
class ValidateModifyApplyMemoParameter implements ValidatePermissionParameterInterface
{
    /**
     * getPermissionSpec
     *
    ...
    {
        return new ModifyApplyMemo($loginUser->getRole());
    }
}
