...
/**
 * AddAttachmentBySecretariat
 * 事務局送付資料の追加権限に関する仕様クラス
 *
 * @package Ncc01\User\Enterprise\Spec\Permission
 */
class AddAttachmentBySecretariat implements PermissionSpecInterface
{
    /**
     * constructor.
     * @param Role $loginUserRole ログイン者のロール
     */
    public function __construct(private Role $loginUserRole)
    {
    }
