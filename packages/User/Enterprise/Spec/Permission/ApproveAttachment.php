...
/**
 * ApproveAttachment
 * 添付ファイルに対する承認を行う権限があるかを判定する。
 * @package Ncc01\User\Enterprise\Spec\Permission
 */
class ApproveAttachment implements PermissionSpecInterface
{
    /**
     * __construct
     *
    ...
    /**
     * canApproveStatus
     * 「提出済」ステータスのみ「承認済」に変更可能
     *
     * @return bool
     */
    protected function canApproveStatus(): bool
    {
