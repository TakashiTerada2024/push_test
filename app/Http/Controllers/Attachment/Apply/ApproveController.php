...
use Ncc01\User\Application\UsecaseInteractor\ValidatePermissionApproveAttachment;
...
class ApproveController extends Controller
{
     ...
     * __construct
     *
     * @param ValidatePermissionApproveAttachment $validatePermissionApproveAttachment
     * @param ChangeAttachmentStatusInterface $changeAttachmentStatus
     */
    public function __construct(
        private ValidatePermissionApproveAttachment $validatePermissionApproveAttachment,
    ...
    {
        if (!$this->validatePermissionApproveAttachment->__invoke(attachmentId: $id)) {
            abort(403);
        }

        $this->changeAttachmentStatus->__invoke($id, AttachmentStatuses::APPROVED);
