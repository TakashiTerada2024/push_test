...
use Ncc01\User\Application\UsecaseInteractor\ValidatePermissionSubmitAttachment;
...
class SubmitController extends Controller
{
     ...
     * __construct
     *
     * @param ValidatePermissionSubmitAttachment $validatePermissionSubmitAttachment
     * @param ChangeAttachmentStatusInterface $changeAttachmentStatus
     */
    public function __construct(
        private ValidatePermissionSubmitAttachment $validatePermissionSubmitAttachment,
    ...
    {
        if (!$this->validatePermissionSubmitAttachment->__invoke(applyId: $applyId, attachmentId: $id)) {
            abort(403);
        }

        $this->changeAttachmentStatus->__invoke($id, AttachmentStatuses::SUBMITTING);
