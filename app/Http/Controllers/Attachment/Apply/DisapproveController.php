...
use Ncc01\User\Application\UsecaseInteractor\ValidatePermissionDisapproveAttachment;
...
class DisapproveController extends Controller
{
     ...
     * __construct
     *
     * @param ValidatePermissionDisapproveAttachment $validatePermissionDisapproveAttachment
     * @param ChangeAttachmentStatusInterface $changeAttachmentStatus
     */
    public function __construct(
        private ValidatePermissionDisapproveAttachment $validatePermissionDisapproveAttachment,
    ...
    {
        if (!$this->validatePermissionDisapproveAttachment->__invoke(attachmentId: $id)) {
            abort(403);
        }
