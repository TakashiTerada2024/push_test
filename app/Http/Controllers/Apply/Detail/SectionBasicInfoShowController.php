 ...
 */
class SectionBasicInfoShowController extends BaseShowController
{
    /**
     * __invoke
     *
    ...
    public function __invoke(int $applyId)
    {
        ...
        $viewPath = $this->buildViewPath($applyId, 'basic_info');
        return View::make($viewPath, [
            'id' => $applyId,
            'isLocked' => $this->isSectionLocked($applyId, 'basic')
        ]);
    }
}
