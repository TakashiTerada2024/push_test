...
class CreatingLinkageController extends Controller
{
    ...
    public function __invoke()
    {
        ...
        return View::make('contents.apply.lists.creating-linkage');
    }
}
