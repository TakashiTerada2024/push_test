...
class PriorConsultationController extends Controller
{
    ...
    public function __invoke()
    {
        ...
        return View::make('contents.apply.lists.prior-consultation');
    }
}
