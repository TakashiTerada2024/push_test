...
{
    public function __construct(private ValidatePermissionShowApplyListsInterface $validatePermissionShowApplyLists)
    {
    }
    ...
    public function __invoke()
    {
        ...
        return view('contents.apply.lists.accepted');
    }
}
