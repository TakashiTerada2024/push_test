 ...
 */
class Section02Composer extends ShowSectionBaseComposer implements ViewComposerInterface, ViewParameterCreator
{
    ...
    public function createParameter(): array
    {
        ...
        return array_merge(
            ...
            [
                'attachment201' => $this->retrieveLatestAttachmentOfType->__invoke($applyId, 201),
                'attachment202' => $this->retrieveLatestAttachmentOfType->__invoke($applyId, 202),
                'attachment203' => $this->retrieveLatestAttachmentOfType->__invoke($applyId, 203),
                'attachment204' => $this->retrieveLatestAttachmentOfType->__invoke($applyId, 204),
                'attachment205' => $this->retrieveLatestAttachmentOfType->__invoke($applyId, 205),
            ]
        );
    }
