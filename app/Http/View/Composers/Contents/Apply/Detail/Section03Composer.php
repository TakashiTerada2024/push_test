 ...
 */
class Section03Composer extends ShowSectionBaseComposer implements ViewComposerInterface, ViewParameterCreator
{
    /** @var RetrieveLatestAttachmentOfTypeInterface $retrieveLatestAttachmentOfType */
    private $retrieveLatestAttachmentOfType;

    /**
     * Section03Composer constructor.
    ...
    public function createParameter(): array
    {
        ...
        return array_merge(
            ...
            [
                'attachment301' => $this->retrieveLatestAttachmentOfType->__invoke($applyId, 301),
                'attachment302' => $this->retrieveLatestAttachmentOfType->__invoke($applyId, 302),
                'attachment303' => $this->retrieveLatestAttachmentOfType->__invoke($applyId, 303),
            ]
        );
    }
