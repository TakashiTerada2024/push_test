 ...
 */
class Section07Composer extends ShowSectionBaseComposer implements ViewComposerInterface, ViewParameterCreator
{
    ...
    public function __construct(
        ...
        private RetrieveActiveAttachmentsOfTypeInterface $retrieveAttachmentsOfType
    ) {
    ...
    public function createParameter(): array
    {
        ...
        $attachments701 = $this->retrieveAttachmentsOfType->__invoke($applyId, 701);
