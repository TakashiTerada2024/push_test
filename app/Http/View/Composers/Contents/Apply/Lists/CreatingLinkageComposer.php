 ...
 */
class CreatingLinkageComposer extends BasicComposer implements ViewComposerInterface
{
    ...
    public function createParameter(): array
    {
        ...
        $parameter1->setType([ApplyTypes::GOVERNMENT_LINKAGE, ApplyTypes::CIVILIAN_LINKAGE]);
        ...
        $parameter2->setType([ApplyTypes::GOVERNMENT_LINKAGE, ApplyTypes::CIVILIAN_LINKAGE]);
