 ...
 */
class CreatingStatisticsComposer extends BasicComposer implements ViewComposerInterface
{
    ...
    public function createParameter(): array
    {
        ...
        $parameter2->setType([ApplyTypes::GOVERNMENT_STATISTICS, ApplyTypes::CIVILIAN_STATISTICS]);
