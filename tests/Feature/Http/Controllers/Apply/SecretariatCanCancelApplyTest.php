...
/**
 * 窓口組織ロールでのログイン時、申請を「中止」ステータスに変更できることのテスト
 * Class SecretariatCanCancelApplyTest
 * @package Tests\Feature\Http\Controllers\Apply
 */
class SecretariatCanCancelApplyTest extends PostHttpStatusCodeTestBase
{
    /**
    ...
    {
        return [
            ['/apply/cancel/1', 302, [], '/welcome'],
            ['/apply/cancel/2', 302, [], '/welcome'],
            ['/apply/cancel/3', 302, [], '/welcome'],
            ['/apply/cancel/4', 302, [], '/welcome'],
        ];
    }
