 ...
 * Class CreatingLinkageControllerTest
 * @package Tests\Feature\Http\Controllers\Apply\Lists
 */
class CreatingLinkageControllerTest extends FeatureTestBase
{
    /**
     * test_Applicant
     *
     * @covers \App\Http\Controllers\Apply\Lists\CreatingLinkageController
     * @author kenji yamamoto <k.yamamoto@balocco.info>
     */
    public function test_ApplicantUserCanNotSeeList()
    {
        $applicantActor = User::find(101);
        $response = $this->actingAs($applicantActor)->get('/apply/lists/creating_linkage');
    ...
    public function test_SecretariatUserCanSeeList()
    {
        ...
        $response = $this->actingAs($secretariatActor)->get('/apply/lists/creating_linkage');
