...
/**
 * Class DisapproveAttachmentTest
 * 添付ファイル承認取消に関する機能テスト
 *
 * @package Tests\Feature\Http\Controllers\Attachment
 */
class DisapproveAttachmentTest extends FeatureTestBase
{
    /**
     * test_ownerApproveAttachment
     *
     ...
     */
    public function test_ownerApproveAttachment(int $attachmentStatus, int $expectedStatus)
    {
        // ユーザー作成
        // テスト用申出者の作成
    ...
    /**
     * test_otherApplicantCannotApproveAttachment
     *
     * @param int $attachmentStatus
     * @author m.shomura <m.shomura@balocco.info>
     * @dataProvider attachmentStatusDataProvider
     */
    public function test_otherApplicantCannotApproveAttachment(int $attachmentStatus)
    {
        // ユーザー作成
        // テスト用申出者の作成
     ...
     */
    public function test_adminApproveAttachment(int $attachmentStatus, int $expectedStatus, int $roleId)
    {
        // ユーザー作成
        // テスト用申出者の作成
