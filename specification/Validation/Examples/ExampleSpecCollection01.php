...
/**
 * ExampleSpecCollection01
 *
 * @package Specification\Validation\Examples
 */
class ExampleSpecCollection01 extends ValidationSpecCollection
{
    //以下、サブクラスに実装を任せる予定のメソッド
    public function __construct($can1,$can2)
    {
        $this->can1 = $can1;
        $this->can2 = $can2;
    }
    ...
    {
        return [
            'notEmpty'=>$this->getSpecName().' ココに定義するとおかしなことになるな？'
        ];
    }
