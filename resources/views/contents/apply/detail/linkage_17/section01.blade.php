                ...
                <x-form-section>
                    ...
                    <x-slot name="form">
                        <div class="col-span-6 sm:col-span-6">
                            <x-form-label for="attachment101">{{config('app-ncc01.attachment-type.101')}}</x-form-label>
                            <x-form-helper-text>がんに係る調査研究のために全国がん登録情報が提供されることについて、書面等の形式で、調査研究対象者の方から適切に同意を得ていることが分かる書類を添付すること。
                            </x-form-helper-text>
