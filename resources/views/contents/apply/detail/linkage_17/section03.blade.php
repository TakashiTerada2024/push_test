...
<x-form-section>
    ...
    <x-slot name="aside">
        @include('contents.apply.detail.sub.exp-modal.linkage-section03-301')
    </x-slot>
...
<x-form-section>
    ...
    <x-slot name="aside">
        @include('contents.apply.detail.sub.exp-modal.linkage_17-section03-302')
    </x-slot>

    <x-slot name="form">
        <div class="col-span-6 sm:col-span-4">
            <x-form-label class="mt-2" for="file2">{{config('app-ncc01.attachment-type.202')}} または {{config('app-ncc01.attachment-type.302')}}</x-form-label>
