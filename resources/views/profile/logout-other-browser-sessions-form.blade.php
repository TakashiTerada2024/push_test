<x-jet-action-section>
    ...
    <x-slot name="content">
        ...
        <div class="flex items-center mt-5">
            <x-jet-button wire:click="confirmLogout" wire:loading.attr="disabled" class="px-6 text-md bg-main-500 hover:bg-base-700">
        ...
        <x-jet-dialog-modal wire:model="confirmingLogout">
            ...
            <x-slot name="footer">
                ...
                <x-jet-button class="ml-2 bg-main-500 hover:bg-base-700"
